...
pub fn build(b: *std.Build) !void {
    ...
    example_imgui.root_module.addImport("merlin_platform", merlin_platform.module("merlin_platform"));
    example_imgui.root_module.addImport("merlin_utils", merlin_utils.module("merlin_utils"));
    example_imgui.root_module.addImport("merlin_gfx", merlin_gfx.module("merlin_gfx"));
    example_imgui.root_module.addImport("merlin_imgui", merlin_imgui.module("merlin_imgui"));
    example_imgui.root_module.addImport("merlin_assets", merlin_assets.module("merlin_assets"));
    example_imgui.root_module.addImport("zmath", zmath.module("root"));
